      ...
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={chartData} margin={{ top: 10, right: 20, bottom: 15, left: 0 }}>
          ...
          <XAxis
            dataKey="distance"
            stroke="#5c6b68"
            tick={{ fill: '#5c6b68', fontSize: 13 }}
            label={{ value: '距离(m)', position: 'insideBottom', offset: -5, fill: '#5c6b68', fontSize: 13, fontWeight: 500 }}
          />
          <YAxis
            stroke="#5c6b68"
            tick={{ fill: '#5c6b68', fontSize: 13 }}
            domain={[0, 100]}
            width={50}
            label={{ value: '伤害%', angle: -90, position: 'insideLeft', fill: '#5c6b68', fontSize: 13, fontWeight: 500 }}
          />
          <Tooltip
            contentStyle={{
            ...
            labelStyle={{ color: '#2f6f73', fontWeight: '600', marginBottom: '4px' }}
